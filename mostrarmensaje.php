...
?>
	...
	<section>
		...
		if (isset($_POST["nombre"],$_POST["apellido"],$_POST["email"], $_POST["fonoContacto"],
			    $_POST["mensajeConsulta"])){
			$nombre= $_POST["nombre"];
			$apellido=$_POST["apellido"];
			$email = $_POST["email"];
			echo "<h2>Estimado(a) " . $nombre . " " . $apellido . " Nos contactaremos a la brevedad a su correo " . $email . "</h2>";
		}else{
			?>
